...
$completeTask = mysqli_query($connection, $completeTaskQuery);
...
<body>
    <div class="container" id="main">
        <h1>Tasks Manager</h1>
        <?php
        if (mysqli_num_rows($completeTask) > 0) {
            ...
            <table>
                ...
                <tbody>
                    <?php
                    while ($cdata = mysqli_fetch_assoc($completeTask)) {
                        ...
                        <tr>
                            ...
                            <a class="incomplete" data-taskid="<?php echo $cdata['id'] ?>" href='#'>Mask Incomplete</a>
                            </td>
                        </tr>.
                    <?php } ?>
                </tbody>
    ...
    <form action="tasks.php" method="post" id="incompletetaskidform">
